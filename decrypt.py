...
if __name__ == '__main__':
    ...
    while not good:
        good = True
        print("Selecte a folder size")
        print("0) All \n1) 21 KB \n2) 150KB \n3) 501KB \n4) 1 MB\n5) 5 MB\n6) 10MB\n7) 1GB")
        choice = input("your selection (number of the selection): ")
        match choice:
            case '0':
    ...
    stop_after = input("How many file do you want to analyze ? (maximaly): ")
    main(subdirs,int(stop_after))
